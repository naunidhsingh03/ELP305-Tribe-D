...
...  Speed is controlled using electric signals (based on the voltage of a potentiometer) • Direction (clockwise/ anticlockwise) can be controlled based on a digital logic [1 or 0] • The L293D motor driver is used. It is designed to provide bidirectional drive currents of up to  600-mA at voltages from 4.5 V to 36 V.  
