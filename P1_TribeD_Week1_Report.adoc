...
| 38         | link:Kumar Sanu Singh          | 2021EE31213| Electrical Team Member                        |ee3211213@ee.iitd.ac.in     | 1
...
| 41         | link:www.linkedin.com/in/kushagrgoyal[Kushagr Goyal]                             | 2021EE10634| Fabrication Team Member                       |ee1210634@ee.iitd.ac.in     | 1
...
| 44         | link:https://www.linkedin.com/in/vadlapudi-manoj-5a764825a[Vadlapudi Manoj]           | 2021MT10245| Documentation Team Member                     |mt1210245@maths.iitd.ac.in  | 1
...
| 59         | link:https://www.linkedin.com/in/aryan-sharma-326657230/[Aryan Sharma]              | 2021EE10141| Fabrication Team Member                       |ee1210141@ee.iitd.ac.in     | 1
...
* link:#_index[4. Index]
* link:#_glossary[5. Glossary]
* link:#_mindmap[6. Mind Map]
* link:#_project_mang[7. Project Management]
* link:#_abstract[8. Abstract]
* link:#_motivation[9. Motivation]
* link:#_machine_mech[10. Mechanism of the Machine]
** link:#_removal[10.1. Removal of Dust using Air]
** link:#_soap_and_water[10.2. Soap + Water Mechanism]
*** link:#_stains[10.2.1. Stains]
*** link:#_solvents[10.2.2. Solvents]
** link:#_scrubbing[10.3. Scrubbing]
** link:#_water_mech[10.4. Water Mechanism]
** link:#_drying[10.5. Drying]
* link:#_requirements[11. Requirements for the Idea]
** link:#_input_specs[11.1. Input Specifications]
** link:#_output_specs[11.2. Output Specifications]
** link:#_power_reqs[11.3. Power Requirements]
** link:#_logi_reqs[11.4. Logistical Requirements]
** link:#_env_reqs[11.5. Environmental Requirements]
** link:#_site_reqs[11.6. Site Requirements]
** link:#_time_reqs[11.7. Time Requirements]
*** link:#_design_time[11.7.1. Design Time Requirements]
*** link:#_time_to_market_reqs[11.7.2. Time to Market Requirements]
*** link:#_lifetime_reqs[11.7.3. Lifetime Requirements]
*** link:#_end_of_life_reqs[11.7.4. End of Life Requirements]
** link:#_other_reqs[11.8. Other Non-Functional Requirements]
